...
export const relations = defineRelations(schema, (r) => ({
  ...
  game: {
    homeTeam: r.one.team({
      ...
      to: r.team.id,
      alias: "game_home_team",
      optional: true,
    }),
    awayTeam: r.one.team({
      from: r.game.awayTeamId,
      to: r.team.id,
      alias: "game_away_team",
      optional: true,
    }),
    homeQb: r.one.player({
      from: r.game.homeQbId,
      to: r.player.id,
      alias: "game_home_qb",
      optional: true,
    }),
    awayQb: r.one.player({
      from: r.game.awayQbId,
      to: r.player.id,
      alias: "game_away_qb",
      optional: true,
    }),
  ...
  pfr_adv_def_season: {
    ...
    team: r.one.team({
      from: r.pfr_adv_def_season.teamId,
      to: r.team.id,
      alias: "pfr_adv_def_season_team",
      optional: true,
    }),
  },
  pfr_adv_def_week: {
    ...
    team: r.one.team({
      from: r.pfr_adv_def_week.teamId,
      to: r.team.id,
      alias: "pfr_adv_def_week_team",
      optional: true,
    }),
  },
  pfr_adv_pass_season: {
    ...
    team: r.one.team({
      from: r.pfr_adv_pass_season.teamId,
      to: r.team.id,
      alias: "pfr_adv_pass_season_team",
      optional: true,
    }),
  },
  pfr_adv_pass_week: {
    ...
    team: r.one.team({
      from: r.pfr_adv_pass_week.teamId,
      to: r.team.id,
      alias: "pfr_adv_pass_week_team",
      optional: true,
    }),
  },
  pfr_adv_rec_season: {
    ...
    team: r.one.team({
      from: r.pfr_adv_rec_season.teamId,
      to: r.team.id,
      alias: "pfr_adv_rec_season_team",
      optional: true,
    }),
  },
  pfr_adv_rec_week: {
    ...
    team: r.one.team({
      from: r.pfr_adv_rec_week.teamId,
      to: r.team.id,
      alias: "pfr_adv_rec_week_team",
      optional: true,
    }),
  },
  pfr_adv_rush_season: {
    ...
    team: r.one.team({
      from: r.pfr_adv_rush_season.teamId,
      to: r.team.id,
      alias: "pfr_adv_rush_season_team",
      optional: true,
    }),
  },
  pfr_adv_rush_week: {
    ...
    team: r.one.team({
      from: r.pfr_adv_rush_week.teamId,
      to: r.team.id,
      alias: "pfr_adv_rush_week_team",
      optional: true,
    }),
  },
  play: {
    ...
    posteamRef: r.one.team({
      from: r.play.posteamId,
      to: r.team.id,
      alias: "play_posteam",
      optional: true,
    }),
    defteamRef: r.one.team({
      from: r.play.defteamId,
      to: r.team.id,
      alias: "play_defteam",
      optional: true,
    }),
  ...
  player: {
    ...
    seasonStats: r.many.player_season_stats({
      from: r.player.id,
      to: r.player_season_stats.playerId,
    }),
    ...
    pfrDefSeason: r.many.pfr_adv_def_season({
      from: r.player.id,
      to: r.pfr_adv_def_season.playerId,
    }),
    pfrPassSeason: r.many.pfr_adv_pass_season({
      from: r.player.id,
      to: r.pfr_adv_pass_season.playerId,
    }),
    pfrRushSeason: r.many.pfr_adv_rush_season({
      from: r.player.id,
      to: r.pfr_adv_rush_season.playerId,
    }),
    pfrRecSeason: r.many.pfr_adv_rec_season({
      from: r.player.id,
      to: r.pfr_adv_rec_season.playerId,
    }),
  ...
  player_season_stats: {
    ...
    team: r.one.team({
      from: r.player_season_stats.teamId,
      to: r.team.id,
      alias: "pss_team",
      optional: true,
    }),
  ...
  player_week_stats: {
    ...
    team: r.one.team({
      from: r.player_week_stats.teamId,
      to: r.team.id,
      alias: "pws_team",
      optional: true,
    }),
    opponentTeamRef: r.one.team({
      from: r.player_week_stats.opponentTeamId,
      to: r.team.id,
      alias: "pws_opponent",
      optional: true,
    }),
  ...
  snap_count: {
    ...
    team: r.one.team({
      from: r.snap_count.teamId,
      to: r.team.id,
      alias: "snap_team",
      optional: true,
    }),
    opponentTeam: r.one.team({
      from: r.snap_count.opponentTeamId,
      to: r.team.id,
      alias: "snap_opponent",
      optional: true,
    }),
  ...
  team: {
    ...
    playerWeekStats: r.many.player_week_stats({
      from: r.team.id,
      to: r.player_week_stats.teamId,
      alias: "pws_team",
    }),
    playerWeekStatsOpponent: r.many.player_week_stats({
      from: r.team.id,
      to: r.player_week_stats.opponentTeamId,
      alias: "pws_opponent",
    }),
    playerSeasonStats: r.many.player_season_stats({
      from: r.team.id,
      to: r.player_season_stats.teamId,
      alias: "pss_team",
    }),
    teamWeekStats: r.many.team_week_stats({
      from: r.team.id,
      to: r.team_week_stats.teamId,
      alias: "tws_team",
    }),
    teamWeekStatsOpponent: r.many.team_week_stats({
      from: r.team.id,
      to: r.team_week_stats.opponentTeamId,
      alias: "tws_opponent",
    }),
    teamSeasonStats: r.many.team_season_stats({
      from: r.team.id,
      to: r.team_season_stats.teamId,
      alias: "tss_team",
    }),
    snapCounts: r.many.snap_count({ from: r.team.id, to: r.snap_count.teamId, alias: "snap_team" }),
    snapCountsOpponent: r.many.snap_count({
      from: r.team.id,
      to: r.snap_count.opponentTeamId,
      alias: "snap_opponent",
    }),
    weeklyRosters: r.many.roster_weekly({
      from: r.team.id,
      to: r.roster_weekly.teamId,
      alias: "rw_team",
    }),
    seasonRosters: r.many.roster_season({
      from: r.team.id,
      to: r.roster_season.teamId,
      alias: "rs_team",
    }),
    injuries: r.many.injury_report({
      from: r.team.id,
      to: r.injury_report.teamId,
      alias: "inj_team",
    }),
    ...
    ngsPassing: r.many.ngs_passing({
      from: r.team.id,
      to: r.ngs_passing.teamId,
      alias: "ngs_pass_team",
    }),
    ngsReceiving: r.many.ngs_receiving({
      from: r.team.id,
      to: r.ngs_receiving.teamId,
      alias: "ngs_rec_team",
    }),
    ngsRushing: r.many.ngs_rushing({
      from: r.team.id,
      to: r.ngs_rushing.teamId,
      alias: "ngs_rush_team",
    }),
    qbrSeasons: r.many.espn_qbr_season({
      from: r.team.id,
      to: r.espn_qbr_season.teamId,
      alias: "qbr_s_team",
    }),
    qbrWeeks: r.many.espn_qbr_week({
      from: r.team.id,
      to: r.espn_qbr_week.teamId,
      alias: "qbr_w_team",
    }),
    draftPicks: r.many.draft_pick({
      from: r.team.id,
      to: r.draft_pick.teamId,
      alias: "draft_team",
    }),
    tradesGave: r.many.trade({ from: r.team.id, to: r.trade.gaveTeamId, alias: "trade_gave" }),
    tradesReceived: r.many.trade({
      from: r.team.id,
      to: r.trade.receivedTeamId,
      alias: "trade_received",
    }),
    pfrDefSeason: r.many.pfr_adv_def_season({
      from: r.team.id,
      to: r.pfr_adv_def_season.teamId,
      alias: "pfr_adv_def_season_team",
    }),
    pfrPassSeason: r.many.pfr_adv_pass_season({
      from: r.team.id,
      to: r.pfr_adv_pass_season.teamId,
      alias: "pfr_adv_pass_season_team",
    }),
    pfrRushSeason: r.many.pfr_adv_rush_season({
      from: r.team.id,
      to: r.pfr_adv_rush_season.teamId,
      alias: "pfr_adv_rush_season_team",
    }),
    pfrRecSeason: r.many.pfr_adv_rec_season({
      from: r.team.id,
      to: r.pfr_adv_rec_season.teamId,
      alias: "pfr_adv_rec_season_team",
    }),
    pfrDefWeek: r.many.pfr_adv_def_week({
      from: r.team.id,
      to: r.pfr_adv_def_week.teamId,
      alias: "pfr_adv_def_week_team",
    }),
    pfrPassWeek: r.many.pfr_adv_pass_week({
      from: r.team.id,
      to: r.pfr_adv_pass_week.teamId,
      alias: "pfr_adv_pass_week_team",
    }),
    pfrRecWeek: r.many.pfr_adv_rec_week({
      from: r.team.id,
      to: r.pfr_adv_rec_week.teamId,
      alias: "pfr_adv_rec_week_team",
    }),
    pfrRushWeek: r.many.pfr_adv_rush_week({
      from: r.team.id,
      to: r.pfr_adv_rush_week.teamId,
      alias: "pfr_adv_rush_week_team",
    }),
    depthChart: r.many.depth_chart({
      from: r.team.id,
      to: r.depth_chart.teamId,
      alias: "depth_team",
    }),
  },
  team_season_stats: {
    team: r.one.team({
      from: r.team_season_stats.teamId,
      to: r.team.id,
      alias: "tss_team",
      optional: true,
    }),
  ...
  team_week_stats: {
    team: r.one.team({
      from: r.team_week_stats.teamId,
      to: r.team.id,
      alias: "tws_team",
      optional: true,
    }),
    opponentTeamRef: r.one.team({
      from: r.team_week_stats.opponentTeamId,
      to: r.team.id,
      alias: "tws_opponent",
      optional: true,
    }),
  ...
  trade: {
    gaveTeam: r.one.team({
      from: r.trade.gaveTeamId,
      to: r.team.id,
      alias: "trade_gave",
      optional: true,
    }),
    receivedTeam: r.one.team({
      from: r.trade.receivedTeamId,
      to: r.team.id,
      alias: "trade_received",
      optional: true,
    }),
