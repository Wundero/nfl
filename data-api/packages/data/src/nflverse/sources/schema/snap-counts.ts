...
export const snapCountSchema = z.object({
  ...
  game_type: z
    ...
    .describe(
      "Game type: REG=Regular Season, WC=Wild Card, DIV=Divisional Playoff, CON=Conference Championship, SB=Super Bowl",
    ),
  ...
  offense_pct: nullableFloat.describe(
    "Fraction (0-1) of the team's offensive snaps played by this player",
  ),
  defense_snaps: nullableFloat.describe("Number of defensive snaps played"),
  defense_pct: nullableFloat.describe(
    "Fraction (0-1) of the team's defensive snaps played by this player",
  ),
  st_snaps: nullableFloat.describe("Number of special teams snaps played"),
  st_pct: nullableFloat.describe(
    "Fraction (0-1) of the team's special teams snaps played by this player",
  ),
});
